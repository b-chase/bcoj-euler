...
squares = [z**2 for z in range(1,10)]
...
class DiceFaces:
    def __init__(self, faces:Iterable):
        ...
        self.faces_for_eq = set(faces)
        if 6 in self.faces_for_eq or 9 in self.faces_for_eq:
            self.faces_for_eq.update([6,9])
        return self
    
    def __eq__(self, other: Self):
        return len(self.faces_for_eq.difference(other.faces_for_eq)) == 0


def can_do_squares(d1:DiceFaces, d2:DiceFaces) -> bool:
    pass
